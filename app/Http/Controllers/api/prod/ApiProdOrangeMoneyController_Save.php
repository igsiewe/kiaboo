...
class ApiProdOrangeMoneyController_Save extends Controller
{
     ...
     *     @OA\RequestBody(
     *         required=true,
     *         description="OM payment request payload",
     *         @OA\JsonContent(
     *             required={"agentNumber","marchandTransactionId","data"},
     ...
     *                 @OA\Property(property="transactionId", type="string", example="txn123"),
     *                 @OA\Property(property="dateTransaction", type="string", format="date", example="2025-06-03"),
     *                 @OA\Property(property="amount", type="number", example=200),
     *                 @OA\Property(property="fees", type="number", example=10),
     *                 @OA\Property(property="agent", type="string", example="659657424"),
     *                 @OA\Property(property="customer", type="string", example="690123456"),
     *                 @OA\Property(property="marchandTransactionID", type="string", example="txn-partner-456")
     *             )
     *         )
     *     ),
     *     @OA\Response(
     *         response=208,
     *         description="Duplicate merchant transaction ID",
     *         @OA\JsonContent(
     *             @OA\Property(property="success", type="boolean", example=false),
