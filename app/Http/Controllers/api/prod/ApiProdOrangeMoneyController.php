...
class ApiProdOrangeMoneyController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->auth_x_token =base64_encode("lyne-claude.kombou@kiaboo.net:24061197a328e0e9cfdff4d7f7") ;//"bHluZS1jbGF1ZGUua29tYm91QGtpYWJvby5uZXQ6MjQwNjExOTdhMzI4ZTBlOWNmZGZmNGQ3Zjc=";
