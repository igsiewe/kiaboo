...
Route::group(['middleware' => ['cors', 'json.response']], function () {
    ...
    Route::controller(ApiOMController::class)->group(function (){
        Route::post('callback/om/cico', 'OMCallBack')->name("OMCallBack");
    });
        ...
        Route::group(['prefix' => 'v1'], function () {
            ...
            Route::group(['prefix' => 'prod'], function () {
                ...
                Route::group(['prefix' => 'mtn'], function () {
                    Route::controller(ApiProdMoMoMonneySwaggerController::class)->group(function () {
                        Route::get('customer/name/{customerPhone}', 'MoMoGetName')->name("MoMoGetName");
                        Route::post('cashin', 'MoMoCashIn')->name("MoMoCashIn");
                        Route::get('cashin/status/{payToken}', 'MoMoCashinStatus')->name("MoMoCashinStatus");
                        Route::post('cashout', 'MoMoCashOut')->name("MoMoCashOut");
