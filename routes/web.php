...
use Illuminate\Support\Facades\{Auth, Redirect, Route, Session};
...
// Routes protégées par auth et checkStatus
Route::middleware(['auth', 'checkStatus'])->group(function () {
    ...
    Route::prefix('approvisionnement')->group(function () {
        Route::controller(WebApproAgentController::class)->group(function () {
            Route::middleware(['role:distributeur,sous-distributeur'])->group(function () {
        ...
        // Approvisionnement Distributeur
        ...
        Route::controller(WebApproDistributeurController::class)->group(function () {
            ...
            Route::middleware(['role:back-office'])->group(function () {
    ...
    // Transactions
    Route::prefix('transactions')->controller(WebTransactionsController::class)->group(function () {
    ...
    // Réconciliation (back-office)
    Route::middleware(['role:back-office'])->prefix('reconciliation')->controller(WebReconciliationController::class)->group(function () {
    ...
    // Commissions (comptable, super-admin)
    Route::middleware(['role:super-administrateur,comptable'])->prefix('commissions')->controller(WebCommissionController::class)->group(function () {
    ...
    // Utilisateurs (exclure dealers)
    Route::middleware(['role:super-administrateur,administrateur'])->prefix('utilisateur')->controller(WebUtilisateurController::class)->group(function () {
    ...
    // Services et Exports (ouverts à tous les rôles connectés)
