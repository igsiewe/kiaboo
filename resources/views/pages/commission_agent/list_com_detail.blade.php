@isset($detailOperation)
            ...
            <div class="modal-header">
                <h5 class="modal-title">Remboursement - N°{{$detailOperation->count()>0?$detailOperation->first()->ref_remb_com_agent:""}} {{" - Agent : ".$detailOperation->first()->name." ".$detailOperation->first()->surname}}</h5>
                ...
                <div class="table-responsive">
                    <table id="add-row"  class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-sort="false">
                        ...
                        <tr>
                            ...
                            <th scope="col" nowrap>Commission Agent</th>
                        </tr>
                        </thead>
                        <tbody>
                            ...
                            @if($detailOperation->isNotEmpty())
                                @foreach($detailOperation as $c)
                                    <tr>
                                        ...
                                        <td nowrap align="right" nowrap>{{number_format($c->commission_agent,0,","," ")." ".$money}}</td>
