            ...
            <div class="row">
                <div class="col-md-12 col-xl-12">
                    <div class="card-header stat-widget card-shadow-danger border-danger">
                        ...
                        <span class="d-inline-block"><h4><b>&nbsp;&nbsp;TRANSACTTIONS EN ATTENTE</b></h4></span>
                    </div>
                </div>
            </div><p/>
...
{{--                                                            <td>#{{$c->reference}}</td>--}}
                                                            ...
                                                            @if($c->status==2)
                                                                <td nowrap style="color: black"><span class="btn btn-warning">PENDING</span></td>
                                                            @else
                                                                <td nowrap style="color: red"><span class="btn btn-danger">ECHEC</span></td>
                                                            @endif
