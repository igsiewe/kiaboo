            ...
            <form action="#" id="frmTransaction" name="frmTransaction">
                ...
                <div class="modal-body">
                    ...
                    <table width="100%"  cellspacing="5" cellpadding="5">
                        ...
                        <tr><td nowrap >Référence partenaire : </td><td colspan="3" nowrap><span style="text-decoration-line: underline; display: flex">{{$transactions->reference_partenaire}}</span></td></tr>
                        ...
                        <tr><td nowrap>Service : </td><td nowrap><span style="text-decoration-line: underline; display: flex">{{$transactions->name_service}}</span></td><td nowrap>Agent : </td><td nowrap><span style="text-decoration-line: underline; display: flex">{{$transactions->agent}}</span></td></tr>
