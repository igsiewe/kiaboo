        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-6 align-content-between align-items-center align-content-center">
                    ...
                    <div class="row">
                        <img src="data:image/png;base64,{{$editProspect->photo_recto}}" alt="Pièce recto" width="150px" height="200px">
                    </div>
                     <p></p>
                    <div class="row">
                        <img src="data:image/png;base64,{{$editProspect->photo_verso}}" alt="Pièce verso" width="150px" height="200px">
                    </div>
