        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            ...
                            <div class="input-group mb-12">
                                ...
                                <input type="text" id="telephone" readonly disabled name="telephone" class="form-control" placeholder="Téléphone *" value="{{ $editProspect->phone }}" aria-label="Téléphone" required>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            ...
                            <div class="input-group mb-12">
                                ...
                                <input type="text" id="typepiece" name="typepiece" disabled class="form-control" placeholder="Type pièce" value="{{ $editProspect->type_piece }}" aria-label="Type pièce" required>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6">
                            ...
                            <div class="input-group mb-12">
                                <span class="input-group-text"><i class="fa fa-id-card"></i></span>
                                <input type="text" id="numcni" name="numcni" disabled class="form-control" placeholder="Numéro CNI *" value="{{ $editProspect->numero_piece }}" aria-label="Numéro pièce" required>
                            </div>
                        </div>
                    </div>
                    <p></p>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            ...
                            <div class="input-group mb-12">
                                <span class="input-group-text"><i class="fa fa-home"></i></span>
                                <input type="text" id="ville" name="ville" disabled class="form-control" value="{{ $editProspect->quartier->ville->name_ville }}" placeholder="Ville" aria-label="Ville" required>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6">
                ...
                <div class="col-md-12 col-lg-4 text-center">
                    <div class="row">
                        <img src="{{ asset('storage/uploads/' . $editProspect->photo_recto) }}" alt="Pièce recto" width="150px" height="220px">
                    </div>
                    <p></p>
                    <div class="row">
                        <img src="{{ asset('storage/uploads/' . $editProspect->photo_verso) }}" alt="Pièce verso" width="150px" height="220px">
                    </div>
                </div>
            </div>
            <p></p>
